...
header("Location: https://www.ownyourlook.com/sms-offer-social/?error=mismatch");
} elseif (($valid_submission == false) && (strpos( $post_outcome, 'Offer already claimed associated with this consumer' ) !== false )) {
header("Location: https://www.ownyourlook.com/sms-offer-social/?error=claimed");
} else 
header("Location: https://www.ownyourlook.com/sms-offer-social/");
?>